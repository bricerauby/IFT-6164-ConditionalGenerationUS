...
def train(patch_sizeSimu=(2, 32, 32), nStepsPerEpoch=1000, n_epoch=10,
    ...
    for epoch in range(n_epoch):
        ...
        for iStep in tqdm.tqdm(range(nStepsPerEpoch)):
            ...
            lossGen = discr_f(genMb, None).mean() + \
                discr_f(realMb, None).mean()
        ...
        if experiment is not None: 
            ...
            experiment.log_metric("loss discriminator MB", loss_discrTotal, epoch=epoch)
        ...
        print("loss generator {:1.1e} | loss discriminator {:1.1e}".format(lossGenTotal,loss_discrTotal))
        state = {
...
if __name__ == '__main__':
    ...
    experiment.add_tag('wgan-gp-style-conditionned')
