...
class PatchDataset(torch.utils.data.Dataset):
    def __init__(self, data_info):
        # Store the patch index, frame index and label for the patches
...
class ClassifierDataset(PatchDataset):
    def __init__(self, prefix, pathMb, pathNoMb, num_frames=None):
        ...
        self.MBdataPath = MBdataPath
        self.noMBdataPath = noMBdataPath
        self.MBdata = h5py.File(MBdataPath, 'r')
        self.noMBdata = h5py.File(noMBdataPath, 'r')
